        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
<!--                Display github logo if project doesn't specifiy a specific icon-->
                <svg v-if="!url.icon" class="w-4 h-4 mr-2 group-hover/btn:rotate-12 transition-transform duration-200" fill="currentColor" viewBox="0 0 20 20">
...
const projects = ref([
  ...
  },
  {
    ...
    urls: [
      ...
      { githubUrl: "https://doc.k0li.fr/", name: "Application" ,type: "app", icon: "🌐" }
    ],
    demoUrl: null
  },
  {
